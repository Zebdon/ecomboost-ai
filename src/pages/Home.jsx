...
const tools = [
  {
    ...
    path: '/ads',
    desc: 'Copy para Facebook, Instagram y TikTok que detiene el scroll. Variaciones optimizadas para conversión.',
  ...
  },
  {
    ...
    title: 'Generador SEO',
    path: '/seo',
    desc: 'Descripciones que venden y posicionan en Google. Contenido único para cada producto o servicio.',
    tags: [],
  ...
  },
  {
    ...
    path: '/nicho',
    desc: 'Valida tu idea antes de invertir un euro. Competencia, audiencia, riesgos y diferenciación real.',
    tags: [],
  ...
  },
  {
    ...
    path: '/branding',
    desc: 'Nombres, slogans y paleta de colores para tu marca. Identidad visual lista en segundos.',
    tags: [],
  ...
  },
  {
    ...
    path: '/lanzamiento',
    desc: 'Tu checklist personalizado paso a paso para no saltarte ningún detalle crítico al lanzar.',
    tags: [],
  ...
  },
  {
    ...
    path: '/email',
    desc: 'Genera secuencias de bienvenida, nutrición y venta que convierten suscriptores en clientes.',
    tags: ['Automatización'],
    bg: 'bg-[#E9F1FA]', border: 'border-[#c2dbf0]', iconColor: 'text-[#1e5f96]', btn: 'bg-[#2f7fc4]',
  },
  {
    icon: '📝',
    title: 'Copy de Página de Ventas',
    path: '/ventas',
    desc: 'Genera el copy completo de tu página de ventas: titular, beneficios, testimonios y CTA.',
    tags: ['Conversión'],
    bg: 'bg-[#FBE9E0]', border: 'border-[#f0c5ab]', iconColor: 'text-[#9c3c14]', btn: 'bg-[#E8642A]',
  },
  {
    ...
    path: '/contenido',
    desc: '30 días de ideas para Instagram, TikTok y LinkedIn adaptadas a tu nicho y audiencia.',
    tags: ['Redes Sociales'],
    bg: 'bg-[#EAF5EC]', border: 'border-[#c2e2c9]', iconColor: 'text-[#2d7a42]', btn: 'bg-[#3f9c58]',
  },
  {
    ...
    path: '/precios',
    desc: 'Descubre cómo estructurar tus precios para maximizar conversión y percepción de valor.',
    tags: [],
    bg: 'bg-[#FBF1DF]', border: 'border-[#f0dba8]', iconColor: 'text-[#9c6d0e]', btn: 'bg-[#d4970f]',
  },
  {
    ...
    path: '/competencia',
    desc: 'Entiende a tus competidores y encuentra los huecos de mercado que puedes aprovechar.',
    tags: [],
    bg: 'bg-[#F0EBFA]', border: 'border-[#d9cdf0]', iconColor: 'text-[#6938b5]', btn: 'bg-[#7e4fd1]',
  },
  {
...
const testimonials = [
  ...
  },
  {
    ...
    text: 'El análisis de competencia y la estrategia de precios me ayudaron a reposicionar mi servicio. Mis clientes notan la diferencia.',
  },
  {
    photo: testimonial3,
    name: 'Laura P.',
    role: 'Creadora de infoproductos',
    text: 'El copy de página de ventas y las secuencias de email me ahorraron contratar un copywriter. Resultados desde el primer día.',
  },
]
    ...
    <div className="bg-white min-h-screen text-black">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
            ...
            >
              <img
                src={pricingPhoto}
                alt="Emprendedor gestionando su negocio digital"
                loading="eager"
                fetchPriority="high"
                width="600"
                height="420"
      ...
      <section className="px-5 lg:px-12 py-12 lg:py-16 bg-[#1C1A17]">
        <div className="max-w-6xl mx-auto">
          <div id="testimonios" className="mb-8 lg:mb-10 scroll-mt-20">
            ...
            <h2 className="text-2xl font-extrabold tracking-tight text-white mb-8">Negocios que ya están creciendo</h2>
          </div>
            ...
            {testimonials.map((t, i) => (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <img src={t.photo} alt={t.name} loading="lazy" className="w-9 h-9 min-w-9 rounded-full object-cover" />
                  <div>
      ...
      <section className="px-5 lg:px-12 py-12 lg:py-16 bg-[#111009]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-gray-400 mt-2">Sin curva de aprendizaje. Resultado en menos de 60 segundos.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-10">
            {[
              { step: '01', icon: '✍️', title: 'Describe tu negocio o producto', desc: 'Escribe en lenguaje natural lo que vendes, tu servicio o tu idea. No necesitas conocimientos técnicos.' },
              ...
              { step: '03', icon: '🚀', title: 'Copia y usa directamente', desc: 'El resultado está listo para pegar en tu web, redes sociales, email o donde lo necesites.' },
            ].map((item, i) => (
              <motion.div
                key={i}
      ...
      >
        ...
        <p className="text-sm lg:text-base text-gray-400 mb-8 max-w-md mx-auto">
          Únete a los emprendedores que ya usan IA para marketing, ventas y crecimiento — sin perder tiempo ni dinero.
        </p>
        <a
          href="https://cyntiaze.gumroad.com/l/uapcse"
          target="_blank"
